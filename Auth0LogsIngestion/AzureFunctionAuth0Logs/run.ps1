...
$AzureQueueName = $env:Auth0LogsQueueName
...
{
    Write-Error -Message "Auth0 Logs Ingestion: Invalid Log Analytics Uri." -ErrorAction Stop
	Exit
}
...
if($LAPostResult -eq 200) {
    Write-Output ("Auth0 Logs have been ingested into Azure Log Analytics Workspace Table")
